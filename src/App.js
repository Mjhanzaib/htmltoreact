                ...
                <div className="row">
                  <div className="col-md-6">
                    <div className="post-entry-1">
                      <a href="post-single.html"><img src="images/img_h_1.jpg" alt="Image" className="img-fluid"></img></a>
                  ...
                  <div className="col-md-6">
                    <PostListItem classes="bg-light" image="images/img_v_1.jpg" title="News Needs to Meet Its Audiences Where They Are" author="Dave Rogers" date="Jun 14" readTime="3 min" category="News" />
                    <PostListItem classes="" image="images/img_v_2.jpg" title="News Needs to Meet Its Audiences Where They Are" author="Dave Rogers" date="Jun 14" readTime="3 min" category="News" />
                    <PostListItem classes="" image="images/img_v_3.jpg" title="News Needs to Meet Its Audiences Where They Are" author="Dave Rogers" date="Jun 14" readTime="3 min" category="News" />
                  </div>
                </div>
              </div>
